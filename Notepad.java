...
public class Notepad extends JFrame implements ActionListener, ItemListener, MenuListener, KeyListener
{
   ...
   String str;
   JMenuBar menubar;
   JMenu file,edit,help, Sanyam;
   JMenuItem newfile,savefile,openfile,exit,cut,copy,paste,about,selall,xyz,abc;
   JTextArea disp;
   ...
   public Notepad()
   {
       ...
       setVisible(true);
       setTitle("Untitled - Notepad - Sanyam");
